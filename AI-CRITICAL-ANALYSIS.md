...
This report compares three Spring Boot applications: one written by a human developers (our team) and two generated by AI tools (GPT and Gemini). All three apps implement the same specification for a space exploration API with planets, moons, and users. The goal is to see how well AI-generated code works compared to human code.
